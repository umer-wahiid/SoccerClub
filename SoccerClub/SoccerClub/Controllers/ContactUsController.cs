...
namespace SoccerClub.Controllers
{
    public class ContactUsController : Controller
    {
        ...
        public ContactUsController(SoccerClubContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.contactUs != null ? 
                          ...
                          Problem("Entity set 'SoccerClubContext.contactUs'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,PhoneNumber,Email,Comment")] ContactUs contactUs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,PhoneNumber,Email,Comment")] ContactUs contactUs)
        {
            if (id != contactUs.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SoccerClubContext.contactUs'  is null.");
            }
            var contactUs = await _context.contactUs.FindAsync(id);
            if (contactUs != null)
            {
